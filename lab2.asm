...
rect_line db 48H,21h, 65H,21h, 6CH,21h, 6CH,21h, 6FH,21h, 21H,21h, 00H,21h
          db 48H,21h, 65H,21h, 6CH,21h, 6CH,21h, 6FH,21h, 21H,21h, 00H,21h
          db 48H,21h, 65H,21h, 6CH,21h, 6CH,21h, 6FH,21h, 21H,21h
...
;-------------------------------------------------------------
 ...
 mov cx,11 ;Лічильник ітерацій циклу
loopStart:;Мітка початку циклу
 ...
 add dx,160;Зімення для наступної лінії
